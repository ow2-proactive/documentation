...
With this interface, a user can run his code locally and test it using a native python kernel, and by a simple switch to
ProActive kernel run it on remote public/private infrastructures without having to modify his code. See the example below:
...
The example below shows how the user can directly follow his submitted job's execution in the scheduling portal:

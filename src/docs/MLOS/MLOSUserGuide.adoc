...
In seconds, you can now switch from executing your code on your local machine and on a remote server. Develop locally
the concepts of your training algorithm with a sample of data. Then, when you are ready, scale to a training on the
complete dataset with an access to an elastic resource pool with more powerful and specialized machines. See the example
below:
...
The example below show how the user can directly see his submitted job being executed in the scheduling portal:

...
| Boolean (default=True)
| `LIMIT_OUTPUT_VIEW`
| Specifies how many rows of the CSV will be previewed in the browser to check each task results.
...
| *Variable name* | *Description* | *Type*
| `COLUMNS_NAME`
| The list of columns that nedd to be dropped. columns names should be separated by a comma.
| String
|===
...
| *Variable name* | *Description* | *Type*
| `COLUMNS_NAME`
| The list of columns that nedd to be encoded. columns names should be separated by a comma.
| String
|===
...
| *Variable name* | *Description* | *Type*
| `COLUMNS_NAME`
| The list of columns to restrict to. column names should be separated by a comma.
| String
|===
...
*Task Overview:* Merge DataFrame objects by performing a database-style join operation based on a specific referene column specified in the `REF_COLUMN` variable.
...
| *Variable name* | *Description* | *Type*
| `GLOBAL_MODEL_TYPE`
| The model that will be used to summarize grouped by data.

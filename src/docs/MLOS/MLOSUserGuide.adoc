...
*Image_Classification:* uses a pre-trained deep neural network to classify ants and bees images.
...
*Fake_Celebrity_Faces_Generation:* generates a wild diversity of fake faces using a GAN model that was trained based on thousands of real celebrity photos.
...
NOTE: It is recommended to use an enabled-GPU node to run the deep learning tasks.
...
*How to use this task:* Should be connected to <<Local_Outlier_Factor>> task or <<One_Class_SVM>> task.
...
| `DOCKER_ENABLED`
| If True,  the tasks will be executed on a Docker container. link:https://hub.docker.com/r/activeeon/dlm3/[activeeon/dlm3] image is used by default.
. If False, the required libraries should be installed in the different nodes that will be used.
| Boolean (default=True)
| `DATASET_TYPE`
...
*How to use this task:* Should be connected with <<Train_Image_Segmentation_Model>>, <<Train_Image_Classification_Model>> or <<Predict_Image_Classification_Model>>, <<Predict_Image_Segmentation_Model>>.
...
*How to use this task:* Should be connected with <<Train_Image_Model>> or <<Train_Text_Model>>.
...
*How to use this task:* Should be connected with <<Predict_Text_Classification_Model>> or <<Predict_Image_Classification_Model>>,  <<Predict_Image_Segmentation_Model>>.
...
*How to use this task:* Should be connected with <<Train_Text_Classification_Model>> or <<Predict_Text_Classification_Model>>.
...
*How to use this task:* Should be used after <<Predict_Text_Model>> or <<Predict_Image_Model>> tasks.

===== Export Images

*Task Overview:* Download a zip file of your results.

*How to use this task:* Should be connected to <<Predict_Image_Model>> task.
...
*How to use this task:* Should be connected to <<Train_Image_Classification_Model>> task.
...
*How to use this task:* Should be connected to <<Train_Image_Segmentation_Model>> task.

NOTE: Pytorch were used to build the model architecture based on https://arxiv.org/abs/1605.06211[FCN^].
...
NOTE: Pytorch were used to build the model architecture based on http://mi.eng.cam.ac.uk/projects/segnet/[SegNet^].
...
NOTE: Pytorch were used to build the model architecture based on https://arxiv.org/abs/1505.04597[UNet^].
...
*How to use this task:* Should be connected to <<Train_Text_Model>> task.
...
*How to use this task:* Should be used after the <<Train_Image_Classification_Model>> or <<Export_Model>> Task.
...
*How to use this task:* Should be used after the <<Train_Text_Classification_Model>> or <<Export_Model>> Task.

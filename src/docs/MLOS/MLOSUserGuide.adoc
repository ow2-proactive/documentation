...
- Using the *Cloud Automation Portal* by executing the different actions associated to MLaaS (i.e., Model_Service, Deploy_AI_Model, Finish_Model_Service, Pause_Model_Service, Resume_Model_Service)
...
| `MODEL_METADATA`
| A vector of numerical data that describes the data. This metadata is used for the purpose of detecting drifts.
...
image::traceability.png[align=center]

=== Via Swagger UI

To access the Swagger UI go to http://try.activeeon.com:port/api/ui/

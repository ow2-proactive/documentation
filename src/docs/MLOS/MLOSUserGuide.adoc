...
image::image_classification.png[400,2000]
...
image::image_segmentation.png[400,2000]
...
image::object_detection.png[400,2000]
...
.Train_Object_Detection_Model variables
[cols="2,5,2"]
|===
| *Variable name* | *Description* | *Type*
| `NUM_EPOCHS`
...
.Predict_Object_Detection_Model Task variables
[cols="2,5,2"]
|===
| *Variable name* | *Description* | *Type*
| `BATCH_SIZE`

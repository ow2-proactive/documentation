...
If you are trying proactive for the first time, please sign up on https://try.activeeon.com/signup.html[try platform].
...
https://doc.activeeon.com/latest/user/ProActiveUserGuide.html#_generic_information[generic_information],
...
To save the created workflow into a https://www.graphviz.org/[GraphViz] _.dot_ format, please use the `#%write_dot()` pragma:

...
*How to use this task:* Should be used after the <<Train_Anomaly_Model>> Task.
...
*Task Overview:* Load and return an image dataset. Each unique label should have its own folder which should contain its related images.
...
*How to use this task:* Should be connected with <<Train_Image_Model>> or <<Predict_Image_Model>>.
...
*How to use this task:* Should be connected with <<Predict_Text_Model>> or <<Predict_Image_Model>>.
...
*How to use this task:* Should be connected with <<Train_Text_Model>> or <<Predict_Text_Model>>.
...
*How to use this task:* Should be connected to <<Train_Image_Model>> task.
...
*How to use this task:* Could be connected to <<Predict_Image_Model>> and <<Export_Model>> tasks.
...
*How to use this task:* Could be connected to <<Predict_Text_Model>> and <<Export_Model>> tasks.
...
*How to use this task:* Should be used after the <<Train_Image_Model>> or <<Export_Model>> Task.
...
*How to use this task:* Should be used after the <<Train_Text_Model>> or <<Export_Model>> Task.

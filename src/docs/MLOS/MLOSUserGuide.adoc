...
*How to use this task:* It should be used after <<Import_Data>> task.
...
*How to use this task:* It should be connected with specific machine learning algorithms suitable to this representation.

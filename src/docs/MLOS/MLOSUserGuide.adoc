...
*How to use this task:*  It should be connected with <<Train_Model>> Task.
...
| String (default=features[7] for a VGG16 model). You can use <model.features[0]> for AlexNet, <model.layer1[0].conv1> for ResNet, etc.
|===

*How to use this task:* It should be used after the <<Train_Image_Classification_Model>> Task.

NOTE: Shap GradientExplainer to explain a deep learning model. More information about this library can be found https://shap.readthedocs.io/en/latest/index.html?highlight=hap_values#shap.DeepExplainer.shap_values[here^]. You can also access https://github.com/slundberg/shap[here^].
...
*How to use this task:*  This task has to be connected to the <<Visdom_Service_Start>> Task. The Visdom server should be up in order to be able to broadcast visualizations.

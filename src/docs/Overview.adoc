...
The Gantt screenshot above shows past job history, current and future ones, all in a comprehensive interactive view.
...
image::job-planner-gantt-overview.png[align=center]

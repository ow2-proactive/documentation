...
The screenshot above shows the *Event Orchestration* portal, where a user can manage and benefit from *Workflow Execution* - smart monitoring system. This ProActive component detects complex events and then triggers user-specified actions according to predefined set of rules.

...
Notification Service:: ProActive component that allows a user or a group of users to subscribe to different types of notifications (web, email, sms or third-party notification tool) when certain event(s) (In-Error, Finished, etc) occur during jobs execution.

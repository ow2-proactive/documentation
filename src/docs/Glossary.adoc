...
[[_glossary_execution_scheduler]]
Execution Scheduler:: A ProActive component providing advanced scheduling options for <<_glossary_workflow,*Workflows*>>.
...
[[_glossary_execution_calendars_object]]
Execution Calendars Object:: Is a json object attached by adding it to the <<_glossary_generic_information,*Generic Information*>>

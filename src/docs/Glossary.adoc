...
Bucket:: ProActive component that manages a collection of stored <<_glossary_workflow, *Workflows*>> (to be more specific <<_glossary_workflow_revision,*Workflow Revisions*>>). 
...
Workflow Revision:: ProActive component that represent one version of a <<_glossary_workflow,*Workflow*>>. Generally speaking, the term <<_glossary_workflow, *Workflow*>> is used to refer to the latest version of a <<_glossary_workflow_revision,*Workflow Revision*>>.

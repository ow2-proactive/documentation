...
ProActive server sizing is based on the number of jobs and tasks executed and submitted per day. It is also based on the number of nodes connected to the server.

The minimal requirements for the server is 4 Cores, 8 GB. An average ProActive Scheduler installation uses 12 cores, 24 GB RAM. Large setups use 24 cores and 100 GB RAM.

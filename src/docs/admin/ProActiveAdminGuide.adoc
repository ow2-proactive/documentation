...
To be able to edit the custom logo in ProActive portals, you have to replace the following file`PROACTIVE_HOME/dist/war/getstarted/assets/image/custom-logo.png` with your logo.

...
* choose one *head node* in your cluster
* http://www.activeeon.com/community-downloads[Download] Proactive Scheduler and unzip the archive
* put the distribution on every *computing nodes* in your cluster
* Optionally http://www.activeeon.com/community-downloads[download] Proactive Agents if you need to set up Proactive
as a service on computing nodes or limit the resource consumptions of Proactive on nodes

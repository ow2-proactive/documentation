...
`user` to have user rights, `admin` to have administrator rights on the scheduler and resource manager. Below is an example `group.cfg` file:
+
.group.cfg
----
admin:admin
...
* `admin` : this group gives full permission on every aspects.

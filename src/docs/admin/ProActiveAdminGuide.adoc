...
link:ProActiveUserGuide.html#_run_computation_with_your_system_account[Run as me] box in the task configuration.
...
executes tasks under it's own system account, to the ProActive group.

Find a a step by step tutorial link:AdminTutorials.html[here].

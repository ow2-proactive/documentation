...
For instance to install the latest windows agent
and select the installer right for your platform, for instance `ProActiveAgent-8.3.0-standalone-x64-setup.exe`.

...
Moreover, it is mandatory to put proper database driver in `PROACTIVE_HOME/addons` folder, e.g. if you want to use MySQL 5.7 database,
then you have to download database driver and put it like this: `PROACTIVE_HOME/addons/mysql-connector-java-8.0.11.jar`.

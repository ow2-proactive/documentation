...
You can change the customer logo interactively in the Automation Dashboard portal (Catalog, Workflow Execution, etc...) using
the `Change Customer Logo` menu item from the Help menu located in the top left corner.

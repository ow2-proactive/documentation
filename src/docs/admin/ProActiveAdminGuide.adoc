...
The execution mechanism of perl task is based on running perl file on your machine.

If you encountered the issues, please check if you have installed Perl properly on you machine.
In order to verify this you can follow next steps:

* For example you should to be able to launch the command 'perl -V'.
* Then from command line you should be able to launch simple perl file (perl yourPerlFile.pl).

...
WARNING: When restarting, ProActive populates the catalog of the new installation with the default objects, by preserving those modified by the user from the old installation (based on the last commit). 

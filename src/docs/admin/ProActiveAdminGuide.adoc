...
Administrators can define which labels can be applied to jobs in the Admin menu of the Scheduler Portal (link to glossary). Physically, possible labels are stored in the scheduler database.
...
The REGEX constrain is specified by the property pa.scheduler.label.regex.

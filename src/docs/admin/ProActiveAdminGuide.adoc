...
We currently provide support for three Database systems, namely HSQLDB, Postgres, and MySQL.
...
This Docker Compose configuration could be used to run the ProActive server container with an external Postgres Database container.

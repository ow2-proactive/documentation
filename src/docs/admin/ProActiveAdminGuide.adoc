...
When you connect the Compute Hosts to the ProActive Resource Manager through the *first method*, a node source of <<_default_infrastructure_manager,*Default Infrastructure*>> is automatically created.

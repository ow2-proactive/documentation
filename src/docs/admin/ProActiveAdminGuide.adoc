...
ProActive Scheduler can be installed and started in two different ways, either manually or automatically.
...
* using Docker Compose, see section <<compose_Automated_ProActive_Installation_with_Docker_Compose>>.
* using Kubernetes, see section <<kube_Automated_ProActive_Installation_with_Kubernetes>>.
* using Shell Scripts, see section <<shell_Automated_ProActive_Installation_with_shell>>.

...
by using `web.https.keystore.password`. A default keystore is provided at the path `config/web/keystore`, with the password `activeeon`.
...
Finally, you will need to update the port number used in the property `jp.url`.

...
WARNING: To fully benefit from the latter management strategy, the infrastructure should be coupled with other than the Empty Policy.
...
The configuration form exposes the following fields:
 ...
 If left blank, the connector will, first, try to get the default VPC ID in the specified region if set, else it will trigger networking autoconfiguration.

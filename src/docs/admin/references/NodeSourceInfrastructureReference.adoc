...
command:
    ...
    $ PROACTIVE_HOME/bin/client --createns defaultns -infrastructure org.ow2.proactive.resourcemanager.nodesource.infrastructure.DefaultInfrastructureManager rmURL
...
source with this infrastructure, run the following command:
    ...
    $ PROACTIVE_HOME/bin/client --createns localns -infrastructure org.ow2.proactive.resourcemanager.nodesource.infrastructure.LocalInfrastructure rmURL credentialsPath numberOfNodes timeout javaProperties
...
Scheduler using the */bin/server* script. An EC2 NodeSource can
now be added using the command line interface of the Resource Manager:

    $ PROACTIVE_HOME/bin/client --createns ec2 -infrastructure org.ow2.proactive.resourcemanager.nodesource.infrastructure.EC2Infrastructure ./config/rm/deployment/ec2.properties rmURL RMCredentialsPath nodeHttpPort
...
jobs can be added by using */bin/client*, or the Scheduler
GUI.
...
LSF server.
    ...
    $ PROACTIVE_HOME/bin/client --createns lsf -infrastructure org.ow2.proactive.resourcemanager.nodesource.infrastructure.LSFInfrastructure rmURL javaPath SSHOptions schedulingPath javaOptions maxNodes nodeTimeout LSFServer RMCredentialsPath bsubOptions
...
the RM to the PBS server.
    ...
    $ PROACTIVE_HOME/bin/client --createns pbs -infrastructure org.ow2.proactive.resourcemanager.nodesource.infrastructure.PBSInfrastructure rmURL javaPath SSHOptions schedulingPath javaOptions maxNodes nodeTimeout PBSServer RMCredentialsPath qsubOptions
...
command:
    ...
    $ PROACTIVE_HOME/bin/client --createns pbs -infrastructure org.ow2.proactive.resourcemanager.nodesource.infrastructure.GenericBatchJobInfrastructure rmURL javaPath SSHOptions schedulingPath javaOptions maxNodes nodeTimeout BatchJobServer RMCredentialsPath subOptions implementationName implementationPath

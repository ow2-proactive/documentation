...
This section describes the available processes to set up the required files in ServiceNow to be able to communicate
...
you will have to manually create files in the destination application, and copy-paste code that will be presented in the next sections.
...
+
image::../../images/servicenow-studio-select.png[align="center"]
    .. Click _Import from source control_
+
image::../../images/servicenow-import-from-source-control.png[align="center"]
    .. Click _Import_. When the application import is completed, click the _Select Application button_.
+
image::../../images/servicenow-imported-from-source-control.png[align="center"]
...
+
image::../../images/servicenow-create-branch.png[align="center"]
...
. link:servicenow/update_set_21813bcd2f9c91103c5d9facf699b605.xml[Download the Update Set].
...
updates on the local instance to detect potential problems. You must preview an update set and address all problems before you can commit the update set.
. Once finished, click on _Close_
. Problems will appear because some tables/records don't exist in the instance and ServiceNow doesn't like that.
...
+
image::../../images/servicenow-accept-remote-update.png[align="center"]
...
The least effective way to create the application.

It requires you to define and create the application in ServiceNow
////
...
Here is an example where the Script Include "SchedulerClient" is called in a Flow Action to submit a job:
...
|restartInErrorTasks
|Executes a PUT request to restart all tasks in error in the job represented by jobid
a|
...
.Functions of the JobRepository Script Include
[cols="1,1,1,1"]
|===
|Function name | Action | Inputs | Output
...
A Subflow is basically a Flow called by a parent Flow.
...
image::../../images/servicenow-action-inputs.png[align="center"]

The Action inputs are accessible by all steps of the Action

.Inputs of the Submit From Catalog script step
image::../../images/servicenow-step-inputs.png[align="center"]
...
image::../../images/servicenow-action-outputs.png[align="center"]

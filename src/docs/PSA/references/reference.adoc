...
<<<<<<< HEAD:src/docs/PCA/references/reference.adoc
The service is started using the following variables.
=======
The service is started using the following variable.
>>>>>>> applying renaming portals change to the documentation:src/docs/PSA/references/reference.adoc
...
=======
=== Model_Service
This service allows to deploy through ProActive Service Automation (PSA) Portal an instance of Model_Service.

NOTE: More details about the related actions of this service can be found in the link:/doc/MLOS/MLOSUserGuide.html#_via_service_automation_portal[MLOS Doc].
>>>>>>> applying renaming portals change to the documentation:src/docs/PSA/references/reference.adoc
...
=======
.Model_Service PSA service variables
>>>>>>> applying renaming portals change to the documentation:src/docs/PSA/references/reference.adoc
[cols="2,5,2,2,2"]
|===
| *Variable name* | *Description* |  *Required?* | *Type*  | *Default/Examples*

...
This service allows to deploy through ProActive Service Automation (PSA) Portal a Greenplum Database server. The service can be started using the following variables.

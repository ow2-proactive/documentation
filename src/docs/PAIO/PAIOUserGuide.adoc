...
12. *TIME_FRAME*: Defines the time period over which the drift is assessed which targets a specific historical period for analysis. It provides context for the drift analysis and trends over time.

13. *METRIC*: Specifies the metric used to measure drift, such as statistical tests or performance measures.

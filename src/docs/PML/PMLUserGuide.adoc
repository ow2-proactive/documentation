...
Check the parameters of the service and click on the button *Submit* to start a MaaS_ML Service Instance.
...
There is also two another action that can be executed from Service Automation Portal which is:

- *Update_MaaS_ML_Parameters*: This action enable you to update the values of the variables associated to the enacted MaaS_ML instance according to your new preferences.
...
To get more information about the parameters of the service, please check the section <<MaaS_DL Via Service Automation Portal>>.

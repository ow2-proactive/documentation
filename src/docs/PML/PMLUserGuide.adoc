...
*Handwritten_Digit_Classification:* trains a simple deep CNN on the MNIST dataset using the PyTorch library. This example allows to search for two architecture defined in a Handwritten_Digit_Classification_Search_Space.json file.

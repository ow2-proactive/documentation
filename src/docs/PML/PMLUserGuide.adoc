...
deploying a specific model, pausing it, to deleting the instance. We will also describe how the life cycle of a MaaS_ML instance
...
Check the parameters of the service and click on the *Submit* button to start a MaaS_ML service instance.
...
You can now monitor the status of the service, access its endpoint and execute its different actions :
...
image::MAAS_ML_Workflow_Management.png[500,500,align=center]
...
In the following subsections, we will describe the life cycle of a MaaS_DL instance, from starting the generic service instance,
deploying a specific model, undeploying it, to deleting the instance. We will also describe how the life cycle of a MaaS_DL instance
can be managed via four different ways in PML:
...
Click on the button *Submit a Job* and then search for *MaaS_DL_Service* workflow as described in the image below.

image::MAAS_DL_Search.png[align=center]

Check the parameters of the service and click on the button *Submit* to start a MaaS_DL service instance.
...
- Redeploy_DL_Model : enables you to redeploy a DL model which was redeployed before.
- Undeploy_ML_Model : enables you to undeploy an already deployed model.

image::MAAS_DL_Workflow_Management.png[500,500,align=center]

...
Drag and drop the `MaaS_ML_Deploy_Model` task from the MaaS_ML bucket.
...
Drag and drop the `MaaS_ML_Call_Prediction` task from the MaaS_ML bucket.
...
Drag and drop the `MaaS_DL_Deploy_Model` task from the MaaS_DL bucket.
...
Drag and drop the `MaaS_DL_Undeploy_Model` task from the MaaS_DL bucket.

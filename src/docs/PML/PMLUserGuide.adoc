...
*Handwritten_Digit_Classification:* trains a simple deep CNN on the MNIST dataset using the PyTorch library. This example allows to search for two architectures defined in a Handwritten_Digit_Classification_Search_Space.json file.
...
*Task Overview:* Explain ML models globally on all data, or locally on a specific data points using the  SHAP and eli5 Python libraries.

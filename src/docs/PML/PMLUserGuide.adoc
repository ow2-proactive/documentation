...
The following workflows are available on the `model_as_a_service`:

*Diabetics_Deploy_Predict_Classifier_Model:* trains a Diabetics Classifier based on a Random Forest Algorithm and the deploys this model in a MaaS_ML service instance.
...
*IRIS_Deploy_Flower_Classifier_Model:* trains an Iris Flower Classifier and deploys it in a new service instance. This instance is stopped when the user validate this action from the Notification portal.

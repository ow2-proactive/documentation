...
- *Update_MaaS_ML_Parameters*: This action enables you to update the variables values associated
...
Traceability tab opens in which the user can check the different chosen values of the MaaS_ML instance
variables. In addition, the traceability information and warnings are listed in a table where each row represents
the initialization, deployment, prediction etc... information during different date/time(s).

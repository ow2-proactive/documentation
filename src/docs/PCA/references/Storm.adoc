...
image::PCA_storm3.png[align=center][100000,2000]

At the end, the instance is listed in the finished instances.

image::PCA_storm4.png[align=center][100000,2000]

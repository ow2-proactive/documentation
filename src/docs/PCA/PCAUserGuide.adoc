...
image::PCA_kafka.png[align=center, width=512, height=256]
...
image::PCA_kafka2.png[align=center, width=512, height=256]

=== Zookeeper

The Zookeeper instance lifecycle management is similar to the Kafka one. 

image::PCA_zookeeper.png[align=center,width=512, height=256]

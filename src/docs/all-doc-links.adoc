...
<li><p><h4 id="all_doc_pws_modules" style="display:inline;font-size:1em""><a href="#all_doc_pws_modules">PWS Modules</a></h4></p>
...
<a href="../MLOS/MLOSUserGuide.html#_proactive_jupyter_kernel">Jupyter Kernel</a></strong></p>
</div>
</div>

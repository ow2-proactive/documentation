...
To clear the filters, you can either click on the Clear filters button next to the filters pills, or use the Clear button the advanced filtering form as you can see in the second screenshot above.
...
To facilitate the time zone selection, the time zone dropdown includes a search field. Users can input a value into this field to filter and reduce the available options.

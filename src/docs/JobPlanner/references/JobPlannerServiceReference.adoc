...
To manage an association's authorizations in the Job-Planner Calendar Associations portal, first select the association, then click on the insert icon button above the associations view as shown in the figure below:

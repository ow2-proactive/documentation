...
To delete an authorization, the admin simply needs to select it from the list and click on the image:../../images/Delete-authorisation-button.png[] button.
The figure below shows an example:
...
The user can manage the global authorizations level of every association he/she created by clicking on the image:../../images/Create-association-owner-button.png[] button above the associations view, as shown in the figure below:

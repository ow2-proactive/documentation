...
Javascript engine allows to run *Javascript* scripts inside ProActive Tasks.
...
Example of Javascript ProActive Task which returns JSON obejct as a result:
...
TIP: To save JSON object as a variable or as a task result

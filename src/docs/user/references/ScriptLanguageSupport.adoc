...
The execution of a Docker_Compose task requires that Docker and Docker Compose are installed on the host machine of the ProActive Node. Please refer to the official
...
To get started, we present below the content of the _Script_ editor of a simple example of a Docker Compose task.

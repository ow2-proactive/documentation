...
When a workflow is submitted from a third-party component (such as a company service), one can set this generic information to a meaningful custom name, that will help identify the Job origin in various portals.
...
* In *Workflow Execution*: the user can see the value in the Generic Information section of the job.

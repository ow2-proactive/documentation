...
Examples: PA:CATALOG_OBJECT will accept "bucket-example/object-example" and "bucket-example/object-example/1539310165443" but not "bucket-example/object-example/153931016" (invalid revision number) nor "bucket-example/" (missing object name).
...
Examples:
** PA:CATALOG_OBJECT(Workflow/standard) will accept standard workflow objects and not PSA workflows or scripts.

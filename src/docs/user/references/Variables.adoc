...
There are specific workflow variables corresponding to icons.
...
These variables are used in the Proactive portals for correct visualization of workflow with icons.

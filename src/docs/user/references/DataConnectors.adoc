...
The Snowflake data connector allows to import and export structured data as well as semi-structured data (JSON, Avro, XML) from and to a Snowflake cloud Data Warehouse.

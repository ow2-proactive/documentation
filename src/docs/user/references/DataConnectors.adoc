...
| `CASSANDRA_INPUT`
a| Path of the CSV file that contains data to be imported. This variable can:
...
The task requires the following third-party credentials: `CASSANDRA_USERNAME` and `CASSANDRA_PASSWORD`. Please refer to the User documentation to learn how to add link:../user/ProActiveUserGuide.html#_third_party_credentials[third-party credentials].
...
| e.g. my_doc_type
| `ELASTICSEARCH_INPUT`
a| A JSON Object/Array to be indexed in ElasticSearch. This variable can:
...
The task requires the following third-party credentials: `ELASTICSEARCH_USERNAME` and `ELASTICSEARCH_PASSWORD`. Please refer to the User documentation to learn how to add link:../user/ProActiveUserGuide.html#_third_party_credentials[third-party credentials].

...
For ruby, python or groovy script languages, the parent tasks results (*results* variable) contains a list of http://doc.activeeon.com/javadoc/latest/org/ow2/proactive/scheduler/common/task/TaskResult.html[TaskResult java object].

...
| *Fork Environment*. Fork Environment variable is a link:/doc/javadoc/org/ow2/proactive/scheduler/common/task/ForkEnvironment.html[ForkEnvironment java object] allowing a script to set various initialization parameters of the forked JVM. See <<_fork_environment, Fork Environment>>
...
| *Scheduler API*. Scheduler API variable is a link:/doc/javadoc/org/ow2/proactive/scheduler/task/client/SchedulerNodeClient.html[SchedulerNodeClient java object] which can connect to the ProActive Scheduler frontend and interact directly with its <<_scheduler_and_dataspace_apis,API>>.
...
| *UserSpace API*. UserSpace API variable is a link:/doc/javadoc/org/ow2/proactive/scheduler/task/client/DataSpaceNodeClient.html[DataSpaceNodeClient java object] which can connect to the <<_global_and_user_spaces,User Space>> and interact directly with its <<_scheduler_and_dataspace_apis,API>>.
...
| *GlobalSpace API*. GlobalSpace API variable is a link:/doc/javadoc/org/ow2/proactive/scheduler/task/client/DataSpaceNodeClient.html[DataSpaceNodeClient java object] which can connect to the <<_global_and_user_spaces,Global Space>> and interact directly with its <<_scheduler_and_dataspace_apis,API>>.
...
For ruby, python, jython or groovy script languages, the parent tasks results (*results* variable) contains a list of link:/doc/javadoc/org/ow2/proactive/scheduler/common/task/TaskResult.html[TaskResult java object].
...
Please see the proper names of the variables in link:/doc/user/ProActiveUserGuide.html#_variables_quick_reference[Variables quick reference]. +

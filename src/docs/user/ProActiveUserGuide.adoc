...
Refer to the <<_topology_types>> for more details.
...
Also it is available in the *ProActive Scheduler Portal* in the _Preview_ tab.
...
Linux it's typically a NFS directory, for Windows it could be a Samba Directory. Then in tasks you can manipulate
...
* Shared folder must be mounted *identically* on all Compute Hosts

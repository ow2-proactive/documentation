...
Indeed, the path must be a valid expression that matches the following pattern: `bucketName/workflowName[/revision]` referencing the workflow to submit from the Catalog (e.g. _basic-examples/Native_Task_)

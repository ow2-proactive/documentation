...
You can drag and drop a 'Python_Task' template from the 'Tasks' menu in order to use Python Script Engine. You can also personalize the Python version that you want to use.
...
and the corresponding py4j module as well. Please refer to

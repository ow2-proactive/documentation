...
The complete API description can be found in the link:../javadoc/index.html?org/ow2/proactive/scheduler/rest/SchedulerClient.html[documentation] of `RMRestInterface` Java interface.

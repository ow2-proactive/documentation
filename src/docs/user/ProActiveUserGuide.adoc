...
Each task has its own result (see secion <<_task_result>>). However, some task results can be marked as *Task Result Added to Job Result*. In that case, this task result will be added to the *Job Result List*.

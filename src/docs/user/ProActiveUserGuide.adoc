...
We show in below an example of a workflow created with different parameters illustrated in the left part of the Figure. The **General Parameters** section contains the following information:

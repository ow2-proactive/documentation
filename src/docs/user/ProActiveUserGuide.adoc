...
* *inherited*: asserts whether the propagated value should be use instead of the *value* value. If *true*, the *value* field can be empty. As a consequence, inheritance requires to declare the variable value at workflow level

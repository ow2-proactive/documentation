...
Before being able to apply a label to a job, an Administrator has to define the label list, see link:../admin/ProActiveAdminGuide.html#_manage_job_labels[*Manage job labels*]

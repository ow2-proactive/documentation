...
Once the task is terminated, you will be able to click on the _FFinished Tasks Output_ button to see the standard output or error associated with the task. +

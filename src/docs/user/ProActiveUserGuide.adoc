...
During their execution, jobs go through different statuses.
The screenshot below shows Pending and Current Jobs statuses summary as seen in Workflow Automation portal.

image::current_job_states.png[align="center", width=350]

.Job Statuses for Pending and Current Jobs
...
The screenshot below shows Past Jobs statuses summary as seen in Workflow Automation portal.

image::past_job_states.png[align="center", width=350, title-align="center"]

.Job Statuses for Past Jobs
[cols="17%,17%,66%", options="header"]
|===
| Status | Name | Description
...
Similarly to jobs, during their execution, tasks go through different statuses.
...
* Each iteration yields one or more task results and the user can query the job status and task statuses to

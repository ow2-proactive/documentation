...
* *sessionid*: The ID of the connection. It allows the user to bypass the login page and directly display the content, it can either be provided in the URL,
or if not provided, the user will need to log in by entering their credentials.
* *name*: The name of the workflow.
...
image::submit_workflow_view1.png[Submit Workflow View]

* *Submit any workflow from a specific bucket:* Provide the bucket name or a substring of it as a query parameter. You can be more precise by using the percentage symbol (`%`), as explained in the example below.

image::submit_workflow_view2.png[Submit Workflow View]

* *Submit specific workflows from a specific buckets:* Provide both the bucket name and the workflow name as query parameters, using the percentage symbol (`%`), as shown in the example below.

image::submit_workflow_view3.png[Submit Workflow View]

* *Submit a single workflow:* When both the bucket and workflow are determined exactly, do not use the percentage symbol (`%`).

image::submit_workflow_view4.png[Submit Workflow View]
...
----
http(s)://your-server:port/#/submit?
----
...
This url display all buckets with names include the substring *ai-deep-learning*, and workflows with names include the substring *train*.
...
This url display all buckets with names include the substring *ai-deep-learning*, and contain workflows with names start by *train*.
...
This url display all buckets with names include the substring *ai-deep-learning*, and contain workflows with names end by *detection*.
...
Alternatively, you can view the above content by using the following URL separately, replacing `{jobid}` with your job ID:

...
Beside from the _id_, _name_ and _project_name_ of the Workflow, a few more information are indexed from the XML content such as _Generic Information_ and _Variables_.

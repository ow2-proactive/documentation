...
Beside from the _id_,_name_ and _project_name_ of the Workflow, a few more information are indexed from the XML content such as _Variables_ and _Generic Information_.
...
NOTE: More detail on pagination and sorting is available on the http://docs.spring.io/spring-data/rest/docs/2.4.2.RELEASE/reference/html/#paging-and-sorting[Spring-data REST documentation].

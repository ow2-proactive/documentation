...
=== Cron Workflows
The *ProActive Scheduler* allows to schedule <<_glossary_workflow,*Workflows*>> with the <<_glossary_execution_scheduler,*Execution Scheduler*>>.
Find more information in the <<_user_execution_scheduler_service,*Execution Scheduler Service*>> section.
...
[[_user_execution_scheduler_service]]
== Execution Scheduler Service

include::./references/ExecutionSchedulerServiceReference.adoc[]

...
Moreover, when the user, who is benefiting from the authorization, log in to his account, she/he will be able to visualize an icon indicating the rights she/he possess over the bucket or the object.

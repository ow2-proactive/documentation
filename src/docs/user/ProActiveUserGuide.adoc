...
The screenshot below shows Pending and Current Jobs status summary as seen in Workflow Execution portal.
...
The screenshot below shows Past Jobs status summary as seen in Workflow Execution portal.
...
* *Project Name*: The name of the project to which belongs the object. The project name can be provided for all objects except workflows. We assume that the project name is defined in the workflow XML file.

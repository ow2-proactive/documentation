...
link:https://jruby.org[Ruby, window="_blank"] and
...
The Catalog provides the storage and versioning of Workflows inside Buckets. It also features a searching functionality using a https://graphql.org/[GraphQL] query language to fetch Workflows based on particular parameters. The Catalog is a RESTful service. A https://swagger.io/[Swagger] interface is provided to understand and interact with the service.

...
In order to be able to authenticate to the LDAP server you need to define for the right Scheduler user in the <<_third_party_credentials,Third-party credentials>>: 

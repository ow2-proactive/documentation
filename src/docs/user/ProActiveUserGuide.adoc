...
* Authorized users: A comma separated list of users who will be notified and able to process the Validation.
...
Authorized users may perform three type of actions on a *Validation*:
...
[title="A Validation in the Notification-Portal"]
...
== Third party ?ProActive? services API

Some ProActive services offers java Clients ready to be used in ProActive's workflows.

=== ProActive Service Automation (PSA) API

The ProActive Service Automation API, or ProActive Service Automation Client, is a way by which a workflow can communicate with ProActive's Service Automation service
using java code to send HTTP requests.

The ProActive Service Automation Client hides the complexity of building and sending HTTP requests manually by providing
ready-to-use classes callable from a groovy task.
...
The complete ProActive Cloud Automation Client API is available in the javadoc link:../javadoc/cloudAutomationClient[Cloud Automation Client JavaDoc].

=== Notification Service API

The Notification Service API, or Notification Client, is a way by which a workflow can communicate with ProActive's Notification Service
using java code to send HTTP requests.
...
By using this groovy script, workflow designers can create custom Notifications anywhere in workflows.

The complete Notification Client API is available in the javadoc link:../javadoc/notificationClient[Notification Client JavaDoc].

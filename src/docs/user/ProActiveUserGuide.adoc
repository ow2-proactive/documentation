...
In order to be able to authenticate to the LDAP server you need to add define for the right Scheduler ser the <<_third_party_credentials,Third-party credentials>>: 
...
You need to have valid a certificate to be able to connect to LDAP server.

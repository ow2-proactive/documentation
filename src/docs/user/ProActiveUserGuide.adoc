...
A Docker_File task allows executing a succession of docker commands according to lifecycle of Docker containers. In order, docker build, docker run, docker stop, and docker rmi are ran when a Docker_File task is executed.
